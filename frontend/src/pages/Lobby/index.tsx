...
const Lobby = ({ className }: I.LobbyProps) => {
    ...
    return (
        <div className={lobbyStyles}>
            ...
            {currentUser.isHost
                ? lobbyStore.started ? <LobbyPlayAdmin giving='lolkek' /> : <LobbyWaitAdmin />
                : lobbyStore.started ? <LobbyPlayGuest giving='lolkek' /> : <LobbyWaitGuest />
            }
        </div>
    );
};
